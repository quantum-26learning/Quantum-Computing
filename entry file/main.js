...
//top flange details
const tf_material =  new THREE.MeshStandardMaterial({color: 0x595959, side: THREE.DoubleSide, roughness: 1, metalness: 1});
...
topflangGrp.add(sidebolttop);
topflangGrp.add(sidebolttop2);
topflangGrp.add(sidebolttop3);
